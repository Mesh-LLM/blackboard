...
//!
//! Run with mesh-llm's generic plugin MCP bridge: `mesh-llm plugin mcp`
...
impl BlackboardServer {
    ...
    async fn post(&self, Parameters(params): Parameters<PostParams>) -> String {
        ...
        match client
            .post(format!(
                "{}/api/plugins/blackboard/http/post",
                base_url(self.port)
            ))
            .json(&body)
            .send()
    ...
    async fn search(&self, Parameters(params): Parameters<SearchParams>) -> String {
        ...
        match client
            .get(format!(
                "{}/api/plugins/blackboard/http/search",
                base_url(self.port)
            ))
    ...
    async fn feed(&self, Parameters(params): Parameters<FeedParams>) -> String {
        ...
        match client
            .get(format!(
                "{}/api/plugins/blackboard/http/feed",
                base_url(self.port)
            ))
            .query(&query_params)
            .send()
